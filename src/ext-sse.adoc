...
| 0x00020000                   | Local Low Priority RAS event
| 0x00020001 - 0x00023fff      | Local events reserved for future use
| 0x00024000 - 0x00027fff      | Platform specific local events
| 0x00028000                   | Global Low Priority RAS event
| 0x00028001 - 0x0002bfff      | Global events reserved for future use
