...
| 0x00000002                   | Local Low Priority RAS event
| 0x00000003 - 0x00003fff      | Local events reserved for future use
| 0x00004000 - 0x00007fff      | Platform specific local events
| 0x00008000                   | Global High Priority RAS event
| 0x00008001                   | Global Low Priority RAS event
| 0x00008002 - 0x0000bfff      | Global events reserved for future use
